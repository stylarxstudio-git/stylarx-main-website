...
import { ArrowLeft, Mail, Youtube, Send, MapPin, Clock, ArrowRight } from "lucide-react"
...
const contactMethods = [
  {
    ...
    contact: "stylarxstudio@gmail.com",
    href: "mailto:stylarxstudio@gmail.com",
  },
  {
    icon: Youtube,
    title: "YouTube Channel",
    description: "Watch tutorials, breakdowns, and asset showcases",
    contact: "Watch on YouTube",
    href: "https://www.youtube.com/@Stylarx-studio",
  },
]
...
export default function ContactPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    const subject = encodeURIComponent(formState.subject || "Contact Form Inquiry")
    const body = encodeURIComponent(
      `Name: ${formState.name}\nEmail: ${formState.email}\n\n${formState.message}`
    )
    window.location.href = `mailto:stylarxstudio@gmail.com?subject=${subject}&body=${body}`
  }
